...
namespace ArtGallery
{
    public partial class PlaceOrder : System.Web.UI.Page
    {
        ...
        {
            String updatepass = "insert into orderaddress1(orderid,address,mobileno,name,pincode) values('" + Label3.Text + "','" + TextBox1.Text + "','" + TextBox2.Text +"','"+TextBox3.Text+"','"+TextBox4.Text+ "')";
            String mycon1 = "Data Source=DESKTOP-R6ROQ4M;Initial Catalog=ShoppingData;Integrated Security=True";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            saveaddress();
            Response.Redirect("PlacedSuccess.aspx?orderid=" + Label3.Text);

        }

        protected void Button2_Click(object sender, EventArgs e)
        {
            Response.Redirect("payment.aspx?orderid=" + Label3.Text);
        }
